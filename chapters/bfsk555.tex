\chapter[BFSK Modulation using 555]{BFSK Modulation using 555}
...
\begin{figure}
\includegraphics[height=7cm,width=\textwidth,trim=2cm 3cm 2cm 2cm,clip=true]{bfsk555.png}
...
\begin{figure}
\begin{center}
\includegraphics[height=7cm,width=10cm]{bfskwaves.png}
