...
\input{./gectitle.tex} %Cover page

%----------------------------------------------------------
%\thispagestyle{empty}
  
\noindent \textcopyright{}2019, Kavya Manohar.\\
\noindent
...
\input{chapters/tdma.tex}
\input{chapters/PAM.tex}
%\input{chapters/pwm.tex}
%\input{chapters/ppm.tex}
\input{chapters/bask.tex}
\input{chapters/bpsk.tex}
\input{chapters/bfsk555.tex}
